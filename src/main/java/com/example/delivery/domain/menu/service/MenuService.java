...
public class MenuService {
  ...
  public List<MenuFindResponseDto> getMenusByStore(Long storeId) {
    ...
    List<Menu> menus = menuRepository.findByStore(findStore);
  ...
  public MenuOrderResponseDto getMenusByOrder(Long orderId) {
    ...
    Menu menu = findOrder.getMenu();
    return new MenuOrderResponseDto(menu.getId(), menu.getMenuName(), menu.getPrice());
